                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <br />
                          <Text>
                            WeFund's mission is to improve and ultimately solve
                            these key aspects of crowdfunding: Projects and
                            project-related events are approved by the
                            community: This helps to give backers what they
                            want, and allows greater agility for projects to
                            adjust and follow market trends. Backers are
                            protected: Funds are released gradually after they
                            are approved by the community. At the same time,
                            this process helps to keep the team's morale and
                            motivation high. Security: By using Anchor protocol
                            we safeguard funds from hackers and human errors,
                            which in turn helps projects to move forward with
                            greater peace of mind. We create a set of
                            fundraising events along the project's development
                            timeline, which gives credibility and a greater
                            chance of success, and at the same time avoids
                            collecting and risking large sums of backer funds
                            before a project demonstrates progress. This helps
                            everyone, the team as well as the project backers.
                            Crowdfunding works when done with fairness,
                            therefore we created a system to maximize the
                            backing opportunity proportional to the number of
                            potential backers, always guaranteeing the
                            possibility for backers to participate. WeFund
                            changes the game: Protects backers and at the same
                            time protects project creators, making the whole
                            process more secure and transparent. WeFund was born
