      ...
      <Center>
        <Tab as={Stack} >
            <Image
                marginTop={10}
                maxH = {100}
                src="https://www.wefund.app/assets/images/prj-startup.svg"
                alt="WeFund"
                /> 
        ...
        <Image
                maxH = {10}
                src="https://www.wefund.app/assets/images/time-not%20yet.svg"
                alt="WeFund"
                marginRight={"70%"}
                /> 
            <Image
                maxH = {100}
                src="https://www.wefund.app/assets/images/prj-gaming.svg"
                alt="WeFund"
                /> 
        ...
        <Image
            ...
            <Image
                maxH = {100}
                src="https://www.wefund.app/assets/images/prj-creative.svg"
                alt="WeFund"
                /> 
                <Stack direction={'row'} spacing={12} p={4}>
        ...
        <Tab as={Stack} >
            <Image
                ...
                <Image
                maxH = {100}
                src="https://www.wefund.app/assets/images/prj-sport.svg"
                alt="WeFund"
                /> 
        ...
        <Image
            ...
            <Image
                maxH = {100}
                src="https://www.wefund.app/assets/images/prj-real%20estate.svg"
                alt="WeFund"
                /> 
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Flex>
            ...
            <Image
              ...
              paddingLeft={20}
              src={
                'https://www.wefund.app/assets/images/gameee.jpg'
              }
              objectFit={'cover'}
            />
            </Box>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Flex>
            ...
            <Image
              ...
              paddingLeft={20}
              src={
                'https://www.wefund.app/assets/images/sejarah-esports-1_169.jpeg'
              }
              objectFit={'cover'}
            />
            </Box>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Flex>
            ...
            <Image
              ...
              paddingLeft={20}
              src={
                'https://www.wefund.app/assets/images/file-20181001-195269-1t3hsge.jpg'
              }
              objectFit={'cover'}
            />
            </Box>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Flex>
            ...
            <Image
              ...
              paddingLeft={20}
              src={
                'https://www.wefund.app/assets/images/448_ergosuntiles.png'
              }
              objectFit={'cover'}
            />
            </Box>
